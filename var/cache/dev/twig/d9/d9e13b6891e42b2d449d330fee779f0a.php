...
class __TwigTemplate_f8696c786320f6f079a4f8a4a6e5f218 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 8
        echo twig_include($this->env, $context, "sponsor/_form.html.twig", ["button_label" => "Update"]);
        echo "
...
{% block body %}
    ...
    {{ include('sponsor/_form.html.twig', {'button_label': 'Update'}) }}

    <a href=\"{{ path('app_sponsor_index') }}\">back to list</a>

    {{ include('sponsor/_delete_form.html.twig') }}
{% endblock %}
", "sponsor/edit.html.twig", "C:\\Users\\fujit\\OneDrive\\Bureau\\PiDev-DevMinds2024-main\\templates\\sponsor\\edit.html.twig");
    }
}
